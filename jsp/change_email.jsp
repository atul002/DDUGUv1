...
<head>
    ...
    <meta name="description" content="DDUGU BCA -  Deen Dayal Upadhyaya Gorakhpur University, Change email address of
    									your user account of DDUGU BCA">

	<meta name="keywords" content="Deen Dayal Upadhyaya Gorakhpur University, BCA, DDUGU BCA - Change Email Address">
    ...
    <title>DDUGU BCA - Change Email address</title>
  ...
  <div class="header">
    ...
    <div class="middle">
      <div class="login">
		...
		<form name = "change_email" action="../ChangeEmail" onsubmit="return validate()" method = "post">
		...
		%>
		  ...
		  <div class="input-container">
		    ...
		    <input class="input-field" type="email" placeholder="<%out.print(email);%>" value="<%out.print(email);%>" name="old_email" disabled>
		  </div>
		  
		  
		  <div class="input-container">
		    <i class="fa fa-envelope icon"></i>
		    <input class="input-field" type="email" placeholder="New Email Address" name="new_email" >
		  </div>
